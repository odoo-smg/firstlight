...
#                else:
            ...
            if line.stock_valuation_layer_id:
                ...
                if cost_detail_value:
                    if cost_detail_value.balance != current_balance or cost_detail_value.cost != current_cost or cost_detail_value.seq != reg:
                ...
                if cost_detail_move:
                    if cost_detail_move.balance != current_balance or cost_detail_move.cost != current_cost or cost_detail_move.seq != reg:
