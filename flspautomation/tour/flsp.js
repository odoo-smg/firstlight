odoo.define('flsp.tour', function(require) {
"use strict";
...
tour.register('flsp_sale_tour_01', {
    url: "/web",
}, [tour.STEPS.SHOW_APPS_MENU_ITEM, {
    trigger: '.o_app[data-menu-xmlid="sale.sale_menu_root"]',
    content: _t('Community: Open Sales app to send your first quotation in a few clicks.'),
    position: 'right',
    edition: 'community'
}, {
    trigger: '.o_app[data-menu-xmlid="sale.sale_menu_root"]',
    content: _t('enterprise: Open Sales app to send your first quotation in a few clicks.'),
    position: 'bottom',
    edition: 'enterprise'
}]);
...
tour.register('flsp_sale_tour_02', {
    url: "/web",
}, [tour.STEPS.SHOW_APPS_MENU_ITEM, {
    trigger: '.o_app[data-menu-xmlid="sale.sale_menu_root"]',
