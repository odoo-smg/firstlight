...
class ReportFlspStructure(models.AbstractModel):
    _name = 'report.report_flsp_structure'
    ...
    def get_html(self, bom_id=False, searchQty=1, searchVariant=False):
        ...
        res['lines'] = self.env.ref('flsp_mrp_structure.report_flsp_mrp_bom').render({'data': res['lines']})
        return res
    ...
    def get_bom(self, bom_id=False, product_id=False, line_qty=False, line_id=False, level=False):
        ...
        return self.env.ref('flsp_mrp_structure.report_flsp_mrp_bom_line').render({'data': lines})
    ...
    def get_operations(self, bom_id=False, qty=0, level=0):
        ...
        return self.env.ref('flsp_mrp_structure.report_flsp_mrp_operation_line').render({'data': values})
