odoo.define('flsp_mrp_structure.flsp_bom_report', function (require) {
'use strict';
...
var FlspBomReport = stock_report_generic.extend({
    ...
    get_html: function() {
        ...
        return this._rpc({
                model: 'report.report_flsp_structure',
                method: 'get_html',
                args: args,
    ...
    renderSearch: function () {
        this.$buttonPrint = $(QWeb.render('flsp_mrp_structure.flsp_button'));
        ...
        this.$searchView = $(QWeb.render('flsp_mrp_structure.report_flsp_search', _.omit(this.data, 'lines')));
        this.$searchView.find('.o_flsp_bom_report_qty').on('change', this._onChangeQty.bind(this));
        this.$searchView.find('.o_flsp_bom_report_variants').on('change', this._onChangeVariants.bind(this));
        this.$searchView.find('.o_flsp_bom_report_type').on('change', this._onChangeType.bind(this));
    },
    _onClickPrint: function (ev) {
        ...
        framework.blockUI();
        var reportname = 'flsp_mrp_structure.report_flsp_structure?docids=' + this.given_context.active_id +
        ...
        var action = {
            ...
            'report_file': 'flsp_mrp_structure.report_flsp_structure',
        };
...
core.action_registry.add('flsp_bom_report', FlspBomReport);
