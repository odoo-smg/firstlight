...
#            "product_id": bom_line.product_id.id,
    ...
    def confirm(self):
        ...
        query = " create table IF NOT EXISTS TMP_TABLE_CALCULATION (id Integer, description text, default_code text, product_tmpl_id Integer, product_id Integer, bom_id Integer, product_qty double precision, level_bom integer); "
        query += " TRUNCATE TMP_TABLE_CALCULATION;"
        query += " CALL flsp_load_boms();"
