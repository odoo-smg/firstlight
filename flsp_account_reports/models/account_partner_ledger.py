...
class ReportPartnerLedger(models.AbstractModel):
    ...
    _name = "flsp.account.partner.ledger"
    ...
    def _get_templates(self):
        ...
        templates['flsp_line_template'] = 'flsp_account_reports.flsp_line_template_partner_ledger_report'
        return templates
    ...
    def _get_options_domain(self, options):
        ...
        if self.env.context.get('model') == 'flsp.account.partner.ledger':
