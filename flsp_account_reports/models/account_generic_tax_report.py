...
class generic_tax_report(models.AbstractModel):
    ...
    _name = 'flsp.account.generic.tax.report'
    ...
    def _get_templates(self):
        ...
        rslt['flsp_search_template'] = 'flsp_account_reports.flsp_search_template_generic_tax_report'
        return rslt
    ...
    def _get_grids_refund_sql_condition(self):
        ...
        This function is for example overridden in pos_flsp_account_reports.
        """
