...
class AccountChartOfAccountReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['flsp_main_table_header_template'] = 'flsp_account_reports.flsp_template_coa_table_header'
        return templates
    ...
    def _get_lines(self, options, line_id=None):
        ...
        accounts_results, taxes_results = self.env['flsp.account.general.ledger']._do_query(options_list, fetch_lines=False)
