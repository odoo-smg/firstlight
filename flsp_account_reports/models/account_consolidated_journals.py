...
class report_flsp_account_consolidated_journal(models.AbstractModel):
    _name = "flsp.account.consolidated.journal"
    ...
    def _get_options(self, previous_options=None):
        options = super(report_flsp_account_consolidated_journal, self)._get_options(previous_options=previous_options)
