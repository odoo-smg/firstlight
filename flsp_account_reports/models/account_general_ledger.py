...
class AccountGeneralLedgerReport(models.AbstractModel):
    _name = "flsp.account.general.ledger"
    ...
    def _get_templates(self):
        ...
        templates['flsp_line_template'] = 'flsp_account_reports.flsp_line_template_general_ledger_report'
        return templates
    ...
    def view_all_journal_items(self, options, params):
        ...
        return self.env['flsp.account.report'].open_journal_items(options, params)
    ...
    def _get_initial_balance_line(self, options, account, amount_currency, debit, credit, balance):
        ...
        return {
            ...
            'class': 'o_flsp_account_reports_initial_balance',
    ...
    def _get_load_more_line(self, options, account, offset, remaining, progress):
        return {
            ...
            'progress': progress,
            'remaining': remaining,
            'class': 'o_flsp_account_reports_load_more text-center',
    ...
    def _get_tax_declaration_lines(self, options, journal_type, taxes_results):
        ...
        tax_report_options = self.env['flsp.account.generic.tax.report']._get_options()
        ...
        tax_report_lines = self.env['flsp.account.generic.tax.report'].with_context(force_company=journal.company_id.id)._get_lines(tax_report_options)
