...
from odoo.addons.flsp_account_reports.tests.common import TestAccountReportsCommon
...
class TestAccountReports(TestAccountReportsCommon):
    ...
    def test_general_ledger_folded_unfolded(self):
        ...
        # Init options.
        report = self.env['flsp.account.general.ledger']
    ...
    def test_general_ledger_multi_company(self):
        ...
        report = self.env['flsp.account.general.ledger'].with_context(allowed_company_ids=company_ids)
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    def test_partner_ledger_folded_unfolded(self):
        ''' Test folded/unfolded lines. '''
        # Init options.
        report = self.env['flsp.account.partner.ledger']
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    def test_partner_ledger_multi_company(self):
        ...
        # Select both company_parent/company_child_eur companies.
        company_ids = (self.company_parent + self.company_child_eur).ids
        report = self.env['flsp.account.partner.ledger'].with_context(allowed_company_ids=company_ids)
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    # -------------------------------------------------------------------------
    # TESTS: FLSP Aged Receivable
    # -------------------------------------------------------------------------

    def test_aged_receivable_folded_unfolded(self):
        ''' Test folded/unfolded lines. '''
        # Init options.
        report = self.env['flsp.account.aged.receivable']
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    def test_aged_receivable_multi_company(self):
        ...
        # Select both company_parent/company_child_eur companies.
        company_ids = (self.company_parent + self.company_child_eur).ids
        report = self.env['flsp.account.aged.receivable'].with_context(allowed_company_ids=company_ids)
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
        report = report.with_context(report._set_context(options))
    ...
    def test_trial_balance_initial_state(self):
        ...
        # Init options.
        report = self.env['flsp.account.coa.report']
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    def test_trial_balance_multi_company(self):
        ...
        # Select both company_parent/company_child_eur companies.
        company_ids = (self.company_parent + self.company_child_eur).ids
        report = self.env['flsp.account.coa.report'].with_context(allowed_company_ids=company_ids)
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    def test_tax_report_comparison_filter(self):
        ''' Test taxes lines. '''
        # Init options.
        report = self.env['flsp.account.generic.tax.report']
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
    ...
    def test_balance_sheet_initial_state(self):
        ...
        # Init options.
        report = self.env.ref('flsp_account_reports.account_financial_report_balancesheet0')._with_correct_filters()
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
        report = report.with_context(report._set_context(options))
    ...
    def test_balance_sheet_multi_company(self):
        ...
        # Select both company_parent/company_child_eur companies.
        company_ids = (self.company_parent + self.company_child_eur).ids
        report = self.env.ref('flsp_account_reports.account_financial_report_balancesheet0')\
    ...
    def test_profit_and_loss_initial_state(self):
        ''' Test folded/unfolded lines. '''
        # Init options.
        report = self.env.ref('flsp_account_reports.account_financial_report_profitandloss0')._with_correct_filters()
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
        report = report.with_context(report._set_context(options))
    ...
    def test_cash_flow_statement_1(self):
        ...
        # Init report / options.
        report = self.env['flsp.account.cash.flow.report'].with_context(allowed_company_ids=self.company_parent.ids)
    ...
    def test_cash_flow_statement_2_multi_company_currency(self):
        # Init report / options.
        report = self.env['flsp.account.cash.flow.report'].with_context(allowed_company_ids=(self.company_parent + self.company_child_eur).ids)
        options = self._init_options(report, *date_utils.get_month(fields.Date.from_string('2015-01-01')))
    ...
    def test_reconciliation_report_initial_state(self):
        ...
        # Init options.
        report = self.env['flsp.account.bank.reconciliation.report'].with_context(active_id=bank_journal.id)
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
        report = report.with_context(report._set_context(options))
    ...
    def test_reconciliation_report_journal_foreign_currency(self):
        ...
        # Init options.
        report = self.env['flsp.account.bank.reconciliation.report'].with_context(active_id=bank_journal_eur.id)
        options = self._init_options(report, *date_utils.get_month(self.mar_year_minus_1))
        report = report.with_context(report._set_context(options))
    ...
    def test_consolidated_journals_folded_unfolded(self):
        ''' Test folded/unfolded lines. '''
        # Init options.
        report = self.env['flsp.account.consolidated.journal']
    ...
    def test_tax_report_grid(self):
        ...
        self.env['ir.model.data'].create({
            'name': 'flsp_account_reports.test_tax_report_tax_11',
            'module': 'flsp_account_reports',
        ...
        self.env['ir.model.data'].create({
            'name': 'flsp_account_reports.test_tax_report_tax_42',
            'module': 'flsp_account_reports',
    ...
    def _create_caba_taxes_for_report_lines(self, report_lines_dict, company):
        ...
        for tax_type, report_line in report_lines_dict.items():
            ...
            self.env['ir.model.data'].create({
                'name': 'flsp_account_reports.test_tax_report_tax_' + tax_type,
                'module': 'flsp_account_reports',
