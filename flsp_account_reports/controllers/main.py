...
class FinancialReportController(http.Controller):
    ...
    @http.route('/flsp_account_reports', type='http', auth='user', methods=['POST'], csrf=False)
    def get_report(self, model, options, output_format, token, financial_id=None, **kw):
        uid = request.session.uid
        flsp_account_report_model = request.env['flsp.account.report']
        ...
        try:
            if output_format == 'xlsx':
                response = request.make_response(
                    None,
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('xlsx')),
            ...
            if output_format == 'pdf':
                response = request.make_response(
                    ...
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('pdf')),
            ...
            if output_format == 'xml':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('xml')),
            ...
            if output_format == 'xaf':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('xaf')),
            ...
            if output_format == 'txt':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('txt')),
            ...
            if output_format == 'csv':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('csv')),
            ...
            if output_format == 'zip':
                ...
                response = request.make_response(
                    content,
                    headers=[
                        ('Content-Type', flsp_account_report_model.get_export_mime_type('zip')),
