odoo.define('flsp_account_reports.flsp_account_reports_tests', function (require) {
"use strict";
...
QUnit.module('Account Reports', {
    ...
    QUnit.test('Account report m2m filters', async function (assert) {
        ...
        var actionManager = await createActionManager({
            ...
            mockRPC: function (route, args) {
                if (route === '/web/dataset/call_kw/flsp.account.report/get_report_informations') {
                    var vals = {
                        ...
                        searchview_html: '<a class="dropdown-toggle" data-toggle="dropdown">' +
                            ...
                            '<li class="o_flsp_account_report_search js_account_partner_m2m"/>' +
                            '</ul>',
                    };
                    var reportOptions;
                    if (count === 1) {
                ...
                if (route === '/web/dataset/call_kw/flsp.account.report/get_html_footnotes') {
